                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                           <div class="btn-group">
                              <div class="buttonexport" id="buttonlist"> 
                                 <a class="btn btn-add" href="{{ route('user.add')}}"> <i class="fa fa-plus"></i> Add User
                                 </a>  
                              </div>
                              ...
                              <ul class="dropdown-menu exp-drop" role="menu">
                                 <li>
                                    ...
                                    <img src="{{asset('assets')}}/dist/img/json.png" width="24" alt="logo"> JSON</a>
                                 </li>
                                 <li>
                                    <a href="#" onclick="$('#dataTableExample1').tableExport({type:'json',escape:'false',ignoreColumn:'[2,3]'});">
                                    <img src="{{asset('assets')}}/dist/img/json.png" width="24" alt="logo"> JSON (ignoreColumn)</a>
                                 </li>
                                 <li><a href="#" onclick="$('#dataTableExample1').tableExport({type:'json',escape:'true'});">
                                    <img src="{{asset('assets')}}/dist/img/json.png" width="24" alt="logo"> JSON (with Escape)</a>
                                 </li>
                                 <li class="divider"></li>
                                 <li><a href="#" onclick="$('#dataTableExample1').tableExport({type:'xml',escape:'false'});">
                                    <img src="{{asset('assets')}}/dist/img/xml.png" width="24" alt="logo"> XML</a>
                                 </li>
                                 <li><a href="#" onclick="$('#dataTableExample1').tableExport({type:'sql'});"> 
                                    <img src="{{asset('assets')}}/dist/img/sql.png" width="24" alt="logo"> SQL</a>
                                 </li>
                                 <li class="divider"></li>
                                 <li>
                                 ...
                                 <li>
                                    ...
                                    <img src="{{asset('assets')}}/dist/img/txt.png" width="24" alt="logo"> TXT</a>
                                 </li>
                                 <li class="divider"></li>
                                 <li>
                                 ...
                                 <li>
                                    ...
                                    <img src="{{asset('assets')}}/dist/img/word.png" width="24" alt="logo"> Word</a>
                                 </li>
                                 <li>
                                    <a href="#" onclick="$('#dataTableExample1').tableExport({type:'powerpoint',escape:'false'});"> 
                                    <img src="{{asset('assets')}}/dist/img/ppt.png" width="24" alt="logo"> PowerPoint</a>
                                 </li>
                                 <li class="divider"></li>
                                 <li>
                                    <a href="#" onclick="$('#dataTableExample1').tableExport({type:'png',escape:'false'});"> 
                                    <img src="{{asset('assets')}}/dist/img/png.png" width="24" alt="logo"> PNG</a>
                                 </li>
                                 <li>
                           ...
                           <div class="table-responsive">
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    <tr>
                                       <td><img src="{{asset('assets')}}/dist/img/w1.png" class="img-circle" alt="User Image" width="50" height="50"> </td>
                                    ...
                                    <tr>
                                       <td><img src="{{asset('assets')}}/dist/img/w2.png" class="img-circle" alt="User Image" width="50" height="50"> </td>
                                       <td>MD. Alrazy</td>
                                       <td>+8801674688663</td>
                                    ...
                                    <tr>
                                       <td><img src="{{asset('assets')}}/dist/img/w3.png" class="img-circle" alt="User Image" width="50" height="50"> </td>
                                    ...
                                    <tr>
                                       <td><img src="{{asset('assets')}}/dist/img/w4.png" class="img-circle" alt="User Image" width="50" height="50"> </td>
